...
public class QuestionActivity extends AppCompatActivity {
    ...
    private Question mQuestions = new Question("JAWA");
...
//            mQuestions = new Question(daerah);
...
//        stopAudio();
    ...
    void initAudio(){
        mediaplayer = new MediaPlayer();
        try {
            mediaplayer.setDataSource(QuestionActivity.this, Uri.parse("android.resource://com.example.cobaa/raw/background"));
//            btnStart.setVisibility(View.GONE);
//            btnStop.setVisibility(View.VISIBLE);
            try {
                mediaplayer.prepare();
