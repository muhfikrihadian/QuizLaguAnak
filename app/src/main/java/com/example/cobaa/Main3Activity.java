...
public class Main3Activity extends AppCompatActivity {
    ...
    private void playAudio(String filename) {
        mediaplayer = new MediaPlayer();
        try {
            mediaplayer.setDataSource(Main3Activity.this, Uri.parse("android.resource://com.example.cobaa/raw/" + filename));
            ...
            e.printStackTrace();
            Toast.makeText(Main3Activity.this, "Maaf tidak dapat memutar lagu", Toast.LENGTH_SHORT).show();
        }
    }
